package robotlegs.app.model
{
	...
	public class LoadModuleService extends Actor implements ILoadModuleService
	{
		// ---------------------------------------------------------------------------------------------------------------------------------------------
		// Internal Properties
		// ---------------------------------------------------------------------------------------------------------------------------------------------
		...
		// Public Methods
		// ---------------------------------------------------------------------------------------------------------------------------------------------
		public function LoadModuleService()
		{
		...
		private function loadProgress(num : int = -1) : void
		{
			...
			dispatch(new LoadModuleEvent(LoadModuleEvent.NOTE_LOAD_PROGRESS, _num));
		}

		private function loadComplete() : void
		{
			loadList.clearCommand(true);
			dispatch(new LoadModuleEvent(LoadModuleEvent.NOTE_LOAD_COMPLETE));
			_groupId = "";
		}

		private function loadModuleParallel(
